...
public record HandResultSummaryResponse(String handId, String sessionId, String heroCards,
        String handRank, BigDecimal netProfit, LocalDateTime date) {

    public static HandResultSummaryResponse of(HandResult entity) {
        return new HandResultSummaryResponse(entity.getHandId(), entity.getSessionId(), entity.getHeroCards().toString(),
